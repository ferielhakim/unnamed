...
background=IMG_Load("menujeu.png");
...
backgroundjeux=IMG_Load("backgroundjeux.jpg");
...
background[5]=IMG_Load("set1.png");
background[6]=IMG_Load("set2.png");
background[7]=IMG_Load("set3.png");
background[8]=IMG_Load("set4.png");
...
musique = Mix_LoadMUS("Menu Theme - New Super Mario Bros. U.mp3");
			    ...
			    switch (event.type)
                    		 {
                      	 	 case SDL_MOUSEMOTION:
                         	   	{
                           		if(event.motion.x>70 && event.motion.x<220 && event.motion.y>190 && event.motion.y<240)
                              			{
                                		SDL_BlitSurface(background[5],NULL,fenetre,&backgroundpos);
                                                SDL_Flip(fenetre);
                              			}
                            		else if(event.motion.x>70 && event.motion.x<220 && event.motion.y>308 && event.motion.y<472)
                              			{
                                		SDL_BlitSurface(background[6],NULL,fenetre,&backgroundpos);
                                                SDL_Flip(fenetre);
                              			}
					else if(event.motion.x>70 && event.motion.x<220 && event.motion.y>508 && event.motion.y<672)
                              			{
                                		SDL_BlitSurface(background[7],NULL,fenetre,&backgroundpos);
                                                SDL_Flip(fenetre);
                              			}
					else if(event.motion.x>70 && event.motion.x<220 && event.motion.y>708 && event.motion.y<800)
                              			{
					...
					if ( event.button.button==SDL_BUTTON_LEFT)
  			   		...
  			   		positionClic.y=event.button.y;
		      	   		music = Mix_LoadMUS("SA FAIS CLIC CLIC.mp3"); //Chargement de la musique
		       	   		//repetition de la musique
		           		Mix_PlayMusic(music, 1);
                           		if(event.button.x>70 && event.button.x<220 && event.button.y>190 && event.button.y<240)
                              			{music = Mix_LoadMUS("SA FAIS CLIC CLIC.mp3"); //Chargement de la musique
		       //repetition de la musique
		       Mix_PlayMusic(music, 1);}
                            		else if(event.button.x>70 && event.button.x<220 && event.button.y>308 && event.button.y<472)
                              			{}
					else if(event.button.x>70 && event.button.x<220 && event.button.y>508 && event.button.y<672)
                              			{}
					else if(event.button.x>70 && event.button.x<220 && event.button.y>708 && event.button.y<800)
                              			{menu();}	
                         		 }
                          	break;
                    	 }
